...
parser.add_argument('--model', type=str, default='GraphSAGE', choices=['APPNP', 'GAT', 'GCN', 'GraphSAGE', 'DAGNN'])
parser.add_argument('--heads', type=int, default=1)
parser.add_argument('--METHOD', type=str, default=None, choices=['SRGNN', 'MMD', None])
parser.add_argument('--TRAININGSET', type=str, default=None, choices=['Baised', None])
parser.add_argument('--BIASDATA', type=str, default=None, choices=['generate_own_bias_data'])
...
parser.add_argument('--conformal_score', type=str, default='aps', choices=['aps', 'cqr'])
...
if args.TRAININGSET == 'Baised':
    name = 'baised_train_' + args.dataset + '_' + args.model
